  ...
  return (
    <div dir="ltr" className="min-h-screen bg-transparent text-[#1A1A1A] relative selection:bg-hot-pink/20 selection:text-hot-pink font-sans overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-6 sm:px-6 lg:px-8">
        <header className="w-full bg-white border border-pink-100/80 rounded-3xl shadow-xs transition-all duration-300 h-18 flex items-center justify-between px-4 sm:px-10">
          
          {/* Left Side: Burger Menu (Mobile Only) */}
          <button className="md:hidden w-10 h-10 flex items-center justify-start text-[#1A1A1A] hover:text-[#D13F7A] transition-colors" aria-label="Menu">
            <Menu size={20} />
          </button>

          {/* Logo Section */}
          <div className="flex items-center gap-2 md:gap-3 justify-center flex-1 md:flex-initial">
             <div className="w-10 h-10 md:w-14 md:h-14 overflow-hidden rounded-xl md:rounded-2xl border border-pink-50 bg-white p-0.5 shadow-xs">
               <img src="/logo.png" alt="Soly's Space" className="w-full h-full object-contain" />
             </div>
             <div className="text-left">
               <h1 className="text-sm md:text-lg font-black tracking-tight text-[#1A1A1A] leading-none font-display">Soly's Space</h1>
               <p className="text-[6.5px] md:text-[8px] text-[#D13F7A] font-extrabold tracking-[0.1em] uppercase mt-0.5 md:mt-1">EMBRACE THE VIBE</p>
             </div>
          </div>
          
          {/* Navigation Links */}
          <nav className="hidden md:flex items-center gap-5 lg:gap-7 text-xs font-semibold uppercase tracking-wider text-slate-700">
            <a href="#about" className="hover:text-[#D13F7A] relative py-1 transition-all duration-300 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[#D13F7A] after:transition-transform after:duration-300 hover:after:origin-bottom-left hover:after:scale-x-100">About Us</a>
          ...
          <div className="w-10 h-10 md:w-auto flex items-center justify-end">
            {/* Desktop Button */}
            <a href="#services" className="hidden md:flex bg-[#D13F7A] text-white hover:bg-[#B13064] hover:scale-[1.03] hover:shadow-[0_8px_20px_rgba(209,63,122,0.3)] active:scale-95 px-6 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 items-center gap-2 group shadow-sm cursor-pointer">
      ...
      {/* Hero Section: Single Large Rounded Image Card */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
        <div className="relative w-full min-h-[780px] md:min-h-[580px] lg:min-h-[650px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-md border border-pink-100/20 flex flex-col justify-between p-6 sm:p-12 lg:p-16">
          ...
          />
          {/* Dark Overlay aligned to the text container */}
          <div className="absolute inset-0 bg-black/55 md:bg-gradient-to-l md:from-black/85 md:via-black/45 md:to-transparent -z-10"></div>
          
          {/* Content Overlaid on Right (RTL displays on the right side) */}
          <div className="w-full md:w-3/5 flex flex-col justify-center items-start text-left text-white space-y-5 z-10 md:pt-4">
          ...
          <div className="w-full bg-black/35 backdrop-blur-md border border-white/10 rounded-2xl md:rounded-full p-5 md:px-10 md:py-5 z-10 mt-8 grid grid-cols-2 md:grid-cols-4 md:flex md:flex-row md:items-center md:justify-between md:gap-0 md:divide-x md:divide-white/15 text-white">
      ...
      <section id="about" className="py-20 bg-white border-y border-pink-100/30">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="text-center space-y-3">
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5.5xl font-normal font-display text-[#1A1A1A] tracking-wider">
              Class Offerings
            </h3>
            <p className="text-sm font-medium text-slate-400">
              Find your fit with programs designed for every girl level.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col space-y-4">
              <div className="relative w-full aspect-[3/4] rounded-[2rem] overflow-hidden shadow-2xs border border-pink-100/30">
                <img 
              ...
              <div className="text-center px-2">
                <h4 className="font-bold text-lg text-[#1A1A1A]">Wellness & Fitness</h4>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="text-center px-2">
                <h4 className="font-bold text-lg text-[#1A1A1A]">Creative Workshops</h4>
                <p className="text-[11px] text-slate-500 font-medium mt-1 leading-relaxed max-w-xs mx-auto">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="text-center px-2">
                <h4 className="font-bold text-lg text-[#1A1A1A]">Lifestyle & Growth</h4>
                <p className="text-[11px] text-slate-500 font-medium mt-1 leading-relaxed max-w-xs mx-auto">
                  Grow your mind
                </p>
              </div>
            ...
            {/* Card 4: Nature & Outdoor */}
            <div className="flex flex-col space-y-4">
              <div className="relative w-full aspect-[3/4] rounded-[2rem] overflow-hidden shadow-2xs border border-pink-100/30">
                <img 
                  src="https://images.unsplash.com/photo-1448375240586-882707db888b?q=80&w=400&auto=format&fit=crop" 
                  alt="Nature & Outdoor" 
                  className="w-full h-full object-cover" 
                />
              </div>
              <div className="text-center px-2">
                <h4 className="font-bold text-lg text-[#1A1A1A]">Nature & Outdoor</h4>
                <p className="text-[11px] text-slate-500 font-medium mt-1 leading-relaxed max-w-xs mx-auto">
                  Reconnect & refresh
                </p>
              </div>
          ...
          <div className="text-center pt-8">
            <a href="#services" className="inline-flex items-center justify-center px-8 py-3 rounded-xl border border-[#D13F7A] text-[#D13F7A] font-bold text-xs uppercase tracking-widest hover:bg-[#D13F7A] hover:text-white transition-all gap-1">
              Explore All Classes <span className="text-[10px] font-sans">&gt;</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-16 relative z-10 bg-[#FFF5F8] border-y border-pink-100/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="testimonials" className="py-24 bg-white border-t border-pink-100/30">
      ...
      {/* Footer Section */}
      <footer id="contact" className="bg-[#FFF5F8] border-t border-pink-100/50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          
          {/* Column 1 - Brand Info */}
          <div className="space-y-6 text-left">
            <div className="flex items-center gap-3 justify-start">
               <div className="w-12 h-12 overflow-hidden rounded-xl border border-pink-100 bg-white p-0.5 shadow-2xs">
                 <img src="/logo.png" alt="Soly's Space" className="w-full h-full object-contain" />
               </div>
               <h2 className="text-xl font-normal text-[#1A1A1A] font-display">Soly's Space</h2>
            </div>
            ...
            <div className="flex gap-3 justify-start pt-2">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-xl bg-white hover:bg-[#D13F7A] hover:text-white transition-all flex items-center justify-center text-[#D13F7A] border border-pink-100/50 shadow-2xs">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-xl bg-white hover:bg-[#D13F7A] hover:text-white transition-all flex items-center justify-center text-[#D13F7A] border border-pink-100/50 shadow-2xs">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="https://snapchat.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-xl bg-white hover:bg-[#D13F7A] hover:text-white transition-all flex items-center justify-center text-[#D13F7A] border border-pink-100/50 shadow-2xs">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="text-left">
            <h4 className="font-bold text-xs uppercase tracking-wider text-slate-400 mb-6">Quick Links</h4>
            <ul className="space-y-4 font-semibold text-slate-600 text-sm">
          ...
          <div className="text-left">
            <h4 className="font-bold text-xs uppercase tracking-wider text-slate-400 mb-6">Contact Us</h4>
            <ul className="space-y-4 font-semibold text-slate-600 text-sm">
              <li className="flex items-center gap-3 justify-start">
                <span dir="ltr" className="font-mono text-sm sm:text-base text-[#1A1A1A] font-bold">+20 100 123 4567</span>
                <div className="w-9 h-9 rounded-lg bg-white border border-pink-100 flex items-center justify-center text-hot-pink shadow-2xs">
                  <Phone size={14} />
                </div>
              </li>
              <li className="flex items-center gap-3 justify-start">
                <span className="text-sm">hello@solysspace.com</span>
                <div className="w-9 h-9 rounded-lg bg-white border border-pink-100 flex items-center justify-center text-hot-pink shadow-2xs">
                  <Mail size={14} />
                </div>
              </li>
              <li className="flex items-start gap-3 justify-start">
                <span className="leading-relaxed text-sm">Fouad Street, Alexandria, Egypt</span>
                <div className="w-9 h-9 rounded-lg bg-white border border-pink-100 flex items-center justify-center text-hot-pink shrink-0 shadow-2xs">
                  <MapPin size={14} />
                </div>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto border-t border-pink-100/20 pt-8 text-center text-xs font-bold uppercase text-slate-400 tracking-wider font-display">
