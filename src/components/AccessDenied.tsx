...
export default function AccessDenied({ message }: { message?: string }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 bg-white border border-pink-100/50 rounded-[2.5rem] shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <h2 className="text-3xl font-black text-[#121212] mb-3">عفواً، الدخول غير مصرح!</h2>
